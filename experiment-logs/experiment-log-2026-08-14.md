...
| 단계 | 항목 | 상태 |
|---|---|---|
| 0 | 측정 시스템 구축 (ESP32/DHT22/정전용량식 센서/INA219 개별 검증) | ✅ 완료 |
...
1. LIR2032 충·방전 특성 측정 (보호회로 경유 충전 필수)
2. 내부저항/ESR 비교, 자가방전 측정 (장시간 소요 — 가능한 일찍 착수 권장)
3. ESP32 소비전력 측정 (Deep Sleep 상태별)
4. 전체 통합 시스템 구성 및 흐린 날 장기 운용 평가

## 10. 참고 — 최종 발표/논문용 정리 방향
