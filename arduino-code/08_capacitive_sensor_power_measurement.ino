// 정전용량식 센서(상시 구동형) 소비전류 측정 (대기 상태 vs 측정 순간)
// 회로: +레일 -> INA219 Vin+ -> [INA219] -> Vin- -> 정전용량식 센서 VCC
//       정전용량식 센서 GND, OUT(GPIO34)는 기존과 동일하게 연결
...
void loop() {
  ...
  Serial.print(" mA | 센서 raw: "); Serial.println(raw);
